...
if (isset($_POST['mail'])) {
    $email = $_POST['mail'];
    $ิbalance = $_POST['ิbalance'];
    $datetransfer = $_POST['datetransfer'];
    $timetransfer = $_POST['timetransfer'];
    $formbank = $_POST['formbank'];
    $tobank = $_POST['tobank'];
      $carts = $_POST['cart'];
      $total = $_POST['total'];
    ...
    if ((!$carts)) {
        ...
        $sql = mysqli_query($con, "INSERT INTO orders2(email, balance ,datetransfer,timetransfer, formbank,tobank) VALUES('$email','$balance','$datetransfer','$timetransfer','$formbank','$tobank')");
...
<div id="content">
    <div class="products-holder" style="background: rgba(0,0,0,.4); border-radius: 10px; width: 700px; margin: 0 auto;">
        ...
        <form action="order_status2.php" method="post" >
