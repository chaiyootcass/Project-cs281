...
if ($query_run = mysqli_query($con, $sql)) {
    ...
    while ($row = mysqli_fetch_assoc($query_run)) {
      ...
      <thead>
        <tr>
          <td colspan="3" style="color: #67b168;" align="left">
            <br/>
            <h3>Order
              <?php echo $i; ?>
            </h3>
...
$sortedCart = array_count_values($cart);
        foreach ($sortedCart as $value => $count) {
            ...
            if ($query_run1 = mysqli_query(mysqli_connect("localhost", "root", "", "cd"), $sql)) {
        ...
        ?>
          ...
          <td align="center">
            <?php $label = $order_status == '1' ? 'Confirmed' : 'Pending';
        echo $label;?>
          </td>
        </tr>
        <?php
    ...
    if ($con == 0) {
        ...
        <tr>
          <td align="center">
            <br/>
            <br/>
            <h3>You have ordered nothing yet!
            </h3>
          </td>
        </tr>
        <?php
